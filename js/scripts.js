$(document).ready(function() {
  ...
  function omdbAjaxCall() {
    var jqxhr = $.getJSON(
      'http://www.omdbapi.com/?apikey=d9ae092c&t=' +
        searchField.val() +
        '&type=movie',
      function(data) {
      ...
      if (searchField.val() !== '' && typeof data.Title == 'undefined') {
        ...
        $('.suggestion').html(
          '<p>No results found. Please refine your search terms.</p>'
        );
      }
      ...
      if (typeof data.Title !== 'undefined') {
        ...
        suggestionItemHTML +=
          '<p class="suggestion-year">' + data.Year + '</p>';
        suggestionItemHTML +=
          '<p class="suggestion-plot">' + data.Plot + '</p>';
